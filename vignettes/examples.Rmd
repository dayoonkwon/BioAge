...
The linear regression models and number of observations in "Table 2" and "Table 3" below are saved as part of the list structure.
These can be drawn by typing ```table``` and ```n```, respectively.
