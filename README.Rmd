...
This serves as an example of training biological aging measures using the
...
```{r, echo=FALSE}
library(readstata13)
CALERIE = read.dta13("/Users/dayoonkwon/Documents/lab/belskylab/project/calerie/Belsky2017JGBS/CALERIE_BAdataR1a.dta") %>%
